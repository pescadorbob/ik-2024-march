...
public class EqualToExpressionShould {

    @Test
    void evaluate_to_false_given_LHS_is_less_than_to_RHS(){
    ...
    @Test
    void evaluate_to_true_given_LHS_is_equal_to_RHS(){
        var expression = anExpression().from("x==5").build();
    ...
    @Test
    void evaluate_to_false_given_LHS_is_greater_than_RHS(){
        var expression = anExpression().from("x==5").build();
        var expected = new ExpressionResult(false);
