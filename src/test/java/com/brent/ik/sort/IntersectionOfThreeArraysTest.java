...
public class IntersectionOfThreeArraysTest {
    @Test
    void testIntersection_equals() throws IOException {
        var threeArrays = loadThreeArrays("input016.json");
        var expectedIntersection = loadSingleArray("output016.json");
        var actual = intersection_equals(threeArrays.arr1,threeArrays.arr2,threeArrays.arr3);
    ...
    public static ArrayList<Integer> intersection_equals(ArrayList<Integer> arr1, ArrayList<Integer> arr2, ArrayList<Integer> arr3){
        ...
        // iterate through the arrays as long as each of the indexes is within bounds of it's array. As
        // soon as it goes out of bounds of its array, it's done as there an intersection can no longer exist.
        while(i<M & j<N & k<O){
